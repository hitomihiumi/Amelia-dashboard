      ...
      <Column maxWidth="m" gap="24" fillWidth>
        ...
        <Column gap="16">
          ...
          <Text variant="body-default-m" onBackground="neutral-medium">
            By inviting Amelia (the "Bot") to your Discord server or logging into our Dashboard, you
            agree to comply with and be bound by these Terms of Service. If you do not agree with
            these terms, you must remove the Bot from your server and cease using the Dashboard.
          </Text>
        </Column>
        ...
        <Column gap="16">
          ...
          <List as={"ul"} textVariant="body-default-m" gap="4">
            ...
            <ListItem>
              Attempt to exploit, bypass, or abuse any of the Bot's systems (e.g., economy exploits,
              API rate limit abuse).
            </ListItem>
            <ListItem>
              Use the Bot to generate or distribute malicious, illegal, or highly offensive content.
            </ListItem>
          </List>
        </Column>
        ...
        <Column gap="16">
          ...
          <Text variant="body-default-m" onBackground="neutral-medium">
            We reserve the right to permanently blacklist users or entire servers from using the Bot
            and Dashboard at our sole discretion, without prior notice, if we determine that these
        ...
        <Column gap="16">
          ...
          <Text variant="body-default-m" onBackground="neutral-medium">
            ...
            use the Bot. We are not responsible for any actions taken by server administrators using
