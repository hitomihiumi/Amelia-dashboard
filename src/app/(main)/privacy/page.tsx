      ...
      <Column maxWidth="m" gap="24" fillWidth>
        ...
        <RevealFx delay={0.4} translateY={-0.5}>
          <Column gap="16">
            ...
            <List as={"ul"} textVariant="body-default-m" gap="4">
              ...
              <ListItem>
                <strong>Guild (Server) Data:</strong> Guild IDs, names, roles, and channel
                structures necessary for configuration.
              </ListItem>
              <ListItem>
        ...
        <RevealFx delay={0.7} translateY={-0.5}>
          <Column gap="16">
            ...
            <List as={"ul"} textVariant="body-default-m" gap="4">
              ...
              <ListItem>
                Personalize user experience (e.g., custom profiles and rank cards).
              </ListItem>
            </List>
          </Column>
        </RevealFx>
        ...
        <RevealFx delay={1.3} translateY={-0.5}>
          <Column gap="16">
            ...
            <Text variant="body-default-m" onBackground="neutral-medium">
              We retain your data for as long as the Bot is present in your Discord server or as
              long as your account is active. If the Bot is removed from a server, related
              configuration data may be deleted. You have the right to request the complete deletion
              of your personal data by contacting the developer team.
            </Text>
          </Column>
        </RevealFx>
