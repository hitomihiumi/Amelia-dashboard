...
export async function generateMetadata({
  ...
  return Meta.generate({
    ...
    image:
      doc.metadata.image ||
      `/api/og/generate?title=${encodeURIComponent(doc.metadata.title)}&description=${encodeURIComponent(doc.metadata.summary || "")}`,
  });
}
          ...
          <Column fillWidth gap="8" vertical="center" paddingTop="40">
            ...
            {doc.metadata.github && (
              <Button
                className="mt-20"
                href={
                  "https://github.com/once-ui-system/core/blob/main/packages/core/src/" +
                  doc.metadata.github
                }
                size="s"
                variant="secondary"
